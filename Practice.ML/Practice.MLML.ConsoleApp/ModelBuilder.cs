...
using Practice.MLML.Model.DataModels;
using Microsoft.ML.Trainers;

namespace Practice.MLML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\GitHub\Practice\Practice.ML\Practice.ML.ConsoleApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../Practice.MLML.Model/MLModel.zip";
